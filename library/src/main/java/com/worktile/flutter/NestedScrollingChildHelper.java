...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, @Nullable int[] consumed,
        ...
        System.out.println("dispatchNestedPreScroll");
        if (isNestedScrollingEnabled()) {
            System.out.println("nestedScrollingEnabled = true");
            final ViewParent parent = getNestedScrollingParentForType(type);
            if (parent == null) {
            ...
            if (dx != 0 || dy != 0) {
                ...
                if (offsetInWindow != null) {
                    mView.getLocationInWindow(offsetInWindow);
                    System.out.println("start offsetInWindow" + Arrays.toString(offsetInWindow));
                    startX = offsetInWindow[0];
                    startY = offsetInWindow[1];
                }
                ...
                if (offsetInWindow != null) {
                    mView.getLocationInWindow(offsetInWindow);
                    System.out.println("end offsetInWindow" + Arrays.toString(offsetInWindow));
                    offsetInWindow[0] -= startX;
                    offsetInWindow[1] -= startY;
                }
                System.out.println("consumed" + Arrays.toString(consumed));
                System.out.println("offsetInWindow" + Arrays.toString(offsetInWindow));
        ...
        System.out.println("nestedScrollingEnabled = false");
        return false;
    }
